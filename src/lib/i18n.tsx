...
const ar: Dict = {
  ...
  "dash.toast.pdfPreparing": "جارٍ تجهيز ملف PDF…",
  "dash.toast.pdfDone": "تم تنزيل ملف PDF",
  "dash.toast.pdfFail": "تعذّر إنشاء PDF — جرّب خيار الطباعة",
...
const en: Dict = {
  ...
  "dash.toast.pdfPreparing": "Preparing your PDF…",
  "dash.toast.pdfDone": "PDF downloaded",
  "dash.toast.pdfFail": "Could not create the PDF — try the Print option",
...
const tr: Dict = {
  ...
  "dash.toast.pdfPreparing": "PDF hazırlanıyor…",
  "dash.toast.pdfDone": "PDF indirildi",
  "dash.toast.pdfFail": "PDF oluşturulamadı — Yazdır seçeneğini deneyin",
...
const paymentAr: Dict = {
  "pay.checkout": "إتمام الاشتراك",
  "pay.backPricing": "العودة للأسعار",
  "pay.choosePlan": "اختر الخطة وطريقة الدفع",
  "pay.available": "طرق الدفع المتاحة",
  "pay.serverStatus": "الحالة من الخادم",
  "pay.oneCycle": "دورة واحدة",
  "pay.autoRenew": "تجديد تلقائي",
  "pay.manualDetails": "تفاصيل التحويل",
  "pay.account": "حساب الاستلام",
  "pay.instructions": "تعليمات الدفع",
  "pay.transaction": "رقم العملية / المرجع",
  "pay.uploadProof": "رفع صورة أو PDF لإثبات الدفع",
  "pay.submitManual": "إرسال طلب الدفع للمراجعة",
  "pay.continueApi": "المتابعة إلى الدفع",
  "pay.pendingTitle": "طلب الدفع قيد المراجعة",
  "pay.pendingBody": "سيتحقق المدير من إثبات الدفع. عند الاعتماد ستُفعّل دورة اشتراك واحدة، بدون تجديد تلقائي.",
  "pay.backDashboard": "العودة إلى لوحة التحميل",
  "pay.viewSubscription": "متابعة الاشتراك",
};
const paymentEn: Dict = {
  "pay.checkout": "Complete subscription",
  "pay.backPricing": "Back to pricing",
  "pay.choosePlan": "Choose a plan and payment method",
  "pay.available": "Available payment methods",
  "pay.serverStatus": "Live server status",
  "pay.oneCycle": "One cycle",
  "pay.autoRenew": "Auto-renewal",
  "pay.manualDetails": "Transfer details",
  "pay.account": "Receiving account",
  "pay.instructions": "Payment instructions",
  "pay.transaction": "Transaction / reference ID",
  "pay.uploadProof": "Upload an image or PDF as payment proof",
  "pay.submitManual": "Submit payment for review",
  "pay.continueApi": "Continue to payment",
  "pay.pendingTitle": "Payment request under review",
  "pay.pendingBody": "The admin will verify your proof. Approval activates one subscription cycle with no automatic renewal.",
  "pay.backDashboard": "Back to dashboard",
  "pay.viewSubscription": "View subscription",
};
const paymentTr: Dict = {
  "pay.checkout": "Aboneliği tamamla",
  "pay.backPricing": "Fiyatlara dön",
  "pay.choosePlan": "Paket ve ödeme yöntemi seçin",
  "pay.available": "Mevcut ödeme yöntemleri",
  "pay.serverStatus": "Sunucu durumu",
  "pay.oneCycle": "Tek dönem",
  "pay.autoRenew": "Otomatik yenileme",
  "pay.manualDetails": "Transfer bilgileri",
  "pay.account": "Alıcı hesap",
  "pay.instructions": "Ödeme talimatları",
  "pay.transaction": "İşlem / referans numarası",
  "pay.uploadProof": "Ödeme kanıtı olarak görsel veya PDF yükleyin",
  "pay.submitManual": "Ödemeyi incelemeye gönder",
  "pay.continueApi": "Ödemeye devam et",
  "pay.pendingTitle": "Ödeme talebi inceleniyor",
  "pay.pendingBody": "Yönetici kanıtınızı kontrol edecek. Onay, otomatik yenileme olmadan tek dönem abonelik başlatır.",
