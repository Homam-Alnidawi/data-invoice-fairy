...
import { BarChart3, ClipboardCheck, CreditCard, Home, LayoutDashboard, LogOut, Menu, Settings, Users } from "lucide-react";
...
const NAV = [
  ...
  { to: "/admin/payment-requests", label: "Payment Requests", icon: ClipboardCheck, exact: false },
] as const;
